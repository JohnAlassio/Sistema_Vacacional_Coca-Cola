...
public class Mainescreen extends JFrame implements ActionListener{
    ...
    public Mainescreen() {
      ...
      setTitle("Pantalla principal - Calcula tus Vacaciones!!! ");
      getContentPane().setBackground(new Color(255,0,0));
      setIconImage(new ImageIcon(getClass().getResource("images/icon.png")).getImage());
      Welcome ventanaWelcome = new Welcome();
      nombreAdministrador = ventanaWelcome.texto;
      ...
      scrollpane1.setBounds(220,333,420,110);
      add(scrollpane1); 
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == miCalculo) {
            ...
            if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||  Departamento.equals("") || Antiguedad.equals("")){
                ...
                if(Departamento.equals("Departamento de Logostica")){
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
            JOptionPane.showMessageDialog(null,"Desarrollado por John Alassio\n"+
            "        www.github.com/JohnAlassio");
...
//Cuando cambies las dimenciones, RECUERDA cambiarlo en cada clase enlazada a este main.